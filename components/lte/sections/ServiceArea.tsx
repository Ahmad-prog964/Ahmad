    ...
    <section className="relative overflow-hidden bg-ink px-6 py-28 md:px-10 md:py-36">
      <div className="mx-auto grid max-w-6xl items-center gap-12 md:grid-cols-2">
        <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-15%" }} transition={{ duration: 0.6 }}>
          <p className="mb-4 font-display text-xs font-semibold uppercase tracking-[0.5em] text-accent-2">Coverage</p>
          <h2 className="text-huge text-4xl text-paper md:text-6xl">Get in touch to check availability.</h2>
          <p className="mt-6 max-w-md text-mute">
            From everyday plumbing repairs to specialist work like hot tub servicing — message us your postcode and we&apos;ll confirm we can get to you.
          </p>
        </motion.div>
