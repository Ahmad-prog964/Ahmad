...
const steps = [
  { n: "01", title: "Call or message", copy: `Tell us the problem and where you are. ${business.phone}.` },
  { n: "02", title: "We come to you", copy: "Fully equipped, at your home, workplace, or roadside." },
  { n: "03", title: "Diagnosed on-site", copy: "We find the fault and explain it before any work starts." },
  { n: "04", title: "Fixed, on the spot", copy: "Most jobs completed in a single visit — no workshop needed." },
];
