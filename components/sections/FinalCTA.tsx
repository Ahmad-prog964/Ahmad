...
export default function FinalCTA() {
  ...
  return (
    <section id="cta-section" className="relative" style={{ height: "170vh" }}>
      <div className="sticky top-0 flex h-screen w-full items-center justify-center px-6">
        <div
          className="pointer-events-none absolute inset-0"
          style={{ background: `radial-gradient(circle at 50% 55%, transparent, rgba(5,5,6,${ctaProgress * 0.75}) 68%)` }}
        />
        <div
          className="relative flex flex-col items-center text-center"
          style={{ opacity: Math.min(1, ctaProgress * 1.6) }}
        >
