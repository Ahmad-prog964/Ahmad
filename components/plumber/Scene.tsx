...
import PlumbingRig from "@/components/plumber/PlumbingRig";
import CameraRig from "@/components/plumber/CameraRig";
...
function SceneContents() {
  const lowPower = usePlumberStore((s) => s.lowPower);
...
export default function Scene() {
  const lowPower = usePlumberStore((s) => s.lowPower);
  const setLowPower = usePlumberStore((s) => s.setLowPower);
