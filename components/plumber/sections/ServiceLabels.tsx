...
import { getActiveService } from "@/lib/plumber/timeline";
...
export default function ServiceLabels() {
  ...
  return (
    <div className="pointer-events-none flex h-full w-full items-center justify-center px-6">
      <div className="text-center transition-all duration-500" style={{ opacity: service ? 1 : 0, transform: `translateY(${service ? 0 : 16}px)` }}>
